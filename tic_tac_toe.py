...
The game allows two players to play against each other by taking turns to place their markers 
(X or O) on a 3x3 grid. 
...
def play_game():
    ...
    while True:
        print_board(board)
        current_player_marker, current_player_name = players[player_index]
